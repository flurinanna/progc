...
static void test_get_mark(void)
{
	...
	mark3 = get_mark(points3, points_6);
	mark4 = get_mark(points4, points_6);
	CU_ASSERT_EQUAL(5, mark1);
	CU_ASSERT_EQUAL(5, mark2);
    CU_ASSERT_EQUAL(1, mark3);
    CU_ASSERT_EQUAL(6, mark4);
}
...
static void test_get_statistics(void)
{
    ...
    CU_ASSERT_EQUAL(generated_statistics.best_mark, 6);
    CU_ASSERT_EQUAL(generated_statistics.worst_mark, 3);
    CU_ASSERT_DOUBLE_EQUAL(generated_statistics.average_mark, 4.92, EPSILON);
    CU_ASSERT_EQUAL(generated_statistics.mark_4, 2);
    CU_ASSERT_EQUAL(generated_statistics.passed, 11);
